<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="eventservice.aspx.cs" Inherits="Admin_eventservice" %>
        ...
        <div class="maincontentinner">
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    <h4 class="widgettitle">Event Service Grid</h4>
                    <table class="table">
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CssClass="table table-bordered table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Event Plan" DataField="eventplanid" />
                                        <asp:BoundField HeaderText="SErvice Package" DataField="servicepackagename" />
                ...
                <asp:View ID="View2" runat="server">
                    <div class="widget">
                        <h4 class="widgettitle">Event Service Detail</h4>
                        <div class="widgetcontent">
                            ...
                            <div class="stdform">
                                <p>
                                    ...
                                    <span class="field">
                                        <asp:DropDownList ID="drpservicepackageid" runat="server"></asp:DropDownList>
                                    </span>
