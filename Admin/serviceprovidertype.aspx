<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="serviceprovidertype.aspx.cs" Inherits="Admin_serviceprovidertype" %>
        ...
        <div class="maincontentinner">
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    <h4 class="widgettitle">Service Provider Type Grid</h4>
                    <table class="table">
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CssClass="table table-bordered table-hover">
                                    <Columns>
                                        ...
                                        <asp:CommandField ShowSelectButton="True" SelectImageUrl="../Images/edit.png" ButtonType="Image" ControlStyle-Width="30" ControlStyle-Height="30" ItemStyle-Width="30"/>
                                        ...
                                        <asp:BoundField HeaderText="ID" DataField="serviceprovidertypeid" />
                                        <asp:BoundField HeaderText="Service Provider Type" DataField="serviceprovidertype" />
                                    </Columns>
                                </asp:GridView>
                            </td>
                        </tr>
                ...
                <asp:View ID="View2" runat="server">
                    <div class="widget">
                        <h4 class="widgettitle">Service Provider Type Detail</h4>
                        <div class="widgetcontent">
                            ...
                            <div class="stdform">
                                <p>
                                    ...
                                    <span class="field">
                                        <asp:TextBox ID="txtserviceprovidertype" runat="server"></asp:TextBox>
                                    </span>
