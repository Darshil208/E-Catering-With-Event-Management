...
using System.Data;
public partial class Admin_eventservice : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = objeventservicedal.selectEventService();
        GridView1.DataBind();
    }
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            objeventservicebal.EventServiceID = Convert.ToInt32(GridView1.SelectedRow.Cells[3].Text);
            objeventservicedal.updateEventService(objeventservicebal);
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ds = objeventservicedal.selectEventServiceByID(id);
